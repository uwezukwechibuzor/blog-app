...
func (authServer) UsernameUsed (_ context.Context, in *proto.UsernameUsedRequest) (*proto.AuthResponse, error) {
	return &proto.UResponse{}, nil
}

func (authServer) EmailUsed (_ context.Context, in *proto.EmailUsedRequest) (*proto.AuthResponse, error) {
